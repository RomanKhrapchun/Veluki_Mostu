...
const cadasterRouter = async (fastify) => {
    ...
    }, cadasterController.findCadasterByFilter);
    ...
    fastify.get("/:id", { 
        ...
        preParsing: RouterGuard({ permissionLevel: "debtor", permissions: accessLevel.VIEW }), 
        config: viewLimit 
    }, cadasterController.getCadasterById);
    ...
    }, cadasterController.createCadaster);
